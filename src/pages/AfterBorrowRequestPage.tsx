...
export default function AfterBorrowRequestPage() {
  ...
  return (
    <div className="page-container bg-white">
      <div className="flex-1 flex flex-col items-center justify-center px-8 gap-6">
        ...
        <h1 className="text-2xl font-bold text-[#1a1a2e] text-center">Borrow request sent!</h1>
        <p className="text-sm text-gray-500 text-center">
          Your borrow request has been sent to the owner. You will be notified once it is approved.
        </p>
        ...
        <div className="bg-[#e5f4fe] rounded-xl p-4 w-full text-sm text-gray-700 space-y-1">
          ...
          <div className="flex justify-between"><span>Period</span><span className="font-semibold">Apr 10 – Apr 17</span></div>
          <div className="flex justify-between"><span>Fee</span><span className="font-semibold">$35 + $20 deposit</span></div>
